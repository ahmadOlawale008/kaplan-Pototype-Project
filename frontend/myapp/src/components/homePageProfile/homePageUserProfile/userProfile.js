...
export default function UserProfile() {
  const ProfileStyledBadge = styled(Badge)(({ theme }) => ({
    "& .MuiBadge-badge": {
  ...
  const [deleteProfileImageDialog, setDeleteProfileimage] = useState(false);
  return (
    <div>
      <Box pb={4}>
        <Box>
          <Box>
            <Stack component={"form"} spacing={3}>
              <Stack spacing={4} direction={"row"} alignItems={"normal"}>
                <ProfileStyledBadge
                  color="primary"
                  overlap="circular"
                  badgeContent={
                    <IconButton
                      onClick={() =>
                        setDeleteProfileimage(!deleteProfileImageDialog)
                      }
                    >
                      <Trash2 color="#f9f9f9" width={20} height={20} />
                    </IconButton>
                  }
                >
                  <Avatar
                ...
                <Box>
                  <Stack spacing={0.3}>
                    <Button
                      ...
                      startIcon={
                        <AddAPhotoOutlinedIcon sx={{ opacity: 0.9 }} />
                      }
                      variant="outlined"
                      color="secondary"
                    >
                  ...
                  <Dialog
                    hideBackdrop
                    onClose={() => setDeleteProfileimage(false)}
                    fullWidth
                  ...
                  >
                    <Box>
                      ...
                      <DialogContent>
                        ...
                        <DialogActions>
                          <Button
                            startIcon={<Trash2 width={17} height={17} />}
              ...
              <TextField
                fullWidth
                label="Email"
                defaultValue={"user_email@gmail.com"}
                required
                InputProps={{ sx: { borderRadius: 40 } }}
                type="email"
              />
              <TextField
                fullWidth
                label="Phone number or company number"
                InputProps={{ sx: { borderRadius: 40 } }}
                type="tel"
              />
              <TextField
